	...
	public function register_routes() {
		...
		register_rest_route(
			...
			array(
				'args'   => array(
					'id' => array(
						'description' => __( 'Unique identifier for the resource.', 'woocommerce-appointments' ),
						'type'        => 'integer',
					),
				),
				array(
				...
				array(
					...
					'args'                => array(
						'force' => array(
							'default'     => false,
							'description' => __( 'Whether to bypass trash and force deletion.', 'woocommerce-appointments' ),
							'type'        => 'boolean',
						),
					),
				),
